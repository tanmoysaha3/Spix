...
internal class TableCreateHelper
{
    ...
    internal async Task InitializeSeriesTables(SQLiteAsyncConnection connection)
    {
        ...
        await CreateTagsTable(connection);
        await CreateSeriesTagsTable(connection);
        ...
        await _databaseIndexHelper.CreateSeriesIndex(connection);
    ...
    private async Task CreateTagsTable(SQLiteAsyncConnection connection)
    {
        ...
        await connection.ExecuteAsync(createTagsTableQuery);
    }

    private async Task CreateSeriesTagsTable(SQLiteAsyncConnection connection)
    {
        string createSeriesTagsTableQuery = @"
            CREATE TABLE IF NOT EXISTS SeriesTagsTable (
                SeriesId INTEGER NOT NULL,
        ...
        await connection.ExecuteAsync(createSeriesTagsTableQuery);
    }
